...
$selectThrillerBooks = $con->prepare($sql);
$selectThrillerBooks->execute();
$thrillerBooks_data = $selectThrillerBooks->fetchAll();
 ?>
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Thriller Books</h1>

    <div class="row">
<?php foreach ($thrillerBooks_data as $book_data) { ?>
