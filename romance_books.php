...
$selectRomanceBooks = $con->prepare($sql);
$selectRomanceBooks->execute();
$romanceBooks_data = $selectRomanceBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Romance Books</h1>

    <div class="row">
<?php foreach ($romanceBooks_data as $book_data) { ?>
