...
<html>
    ...
    <h2>User Table</h2>
    <table class="table" style="width: 75%; margin: 5% 0 0 1%;">
  <thead>
    <tr>
  ...
  <tbody class="table-group-divider">
    ...
    <tr>
      ...
      <td><img src="img/<?php echo $row['book_photo']; ?>" width="100"></td>
            <td><?php echo $row['book_name']; ?></td>
            <td><?php echo $row['book_author']; ?></td>
            <td><?php echo $row['book_price']; ?></td>
                <td><a style="color: red;" href="delete.php?book_id=<?php echo $row['book_id']; ?>">Delete</a></td>
    </tr>
    <?php endforeach; ?>
  </tbody>
</table>
