...
// $selectFictionBooks = $con->prepare($sql);
//   $selectFictionBooks->execute();

//   $fictionBooks_data = $selectFictionBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Fiction Books</h1>

    <div class="row">
<?php foreach ($fictionBooks_data as $book_data) { ?>
      <div class="col-6 col-md-4 col-lg-3 nonfiction_books hvr-grow">
        ...
        <p><?php echo $book_data['book_price']; ?>$</p></a>
