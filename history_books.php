...
$selectHistoricalBooks = $con->prepare($sql);
$selectHistoricalBooks->execute();
$historicalBooks_data = $selectHistoricalBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Historical Books</h1>

    <div class="row">
<?php foreach ($historicalBooks_data as $book_data) { ?>
