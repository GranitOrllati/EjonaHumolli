...
$sql = "SELECT b.*, g.name AS genre_name
        ...
        WHERE g.name = 'Politics'
        ORDER BY b.book_id DESC";  // Using 'book_id' for ordering in descending order

$selectPoliticsBooks = $con->prepare($sql);
$selectPoliticsBooks->execute();
$politicsBooks_data = $selectPoliticsBooks->fetchAll();
 ?>
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Politic Books</h1>

    <div class="row">
<?php foreach ($politicsBooks_data as $book_data) { ?>
