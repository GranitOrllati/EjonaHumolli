...
$selectFantasyBooks = $con->prepare($sql);
$selectFantasyBooks->execute();
$fantasyBooks_data = $selectFantasyBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Fantasy Books</h1>

    <div class="row">
<?php foreach ($fantasyBooks_data as $book_data) { ?>
