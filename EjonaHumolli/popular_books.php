...
<head>
    ...
    <div class="offcanvas-body">
		...
		<!-- <h1 class="header-h1" style="margin-top: 7%;">BESTSELLERS</h1> -->

		
		<div class="row d-flex justify-content-center align-items-center" >
		<?php foreach ($popularBooks_data as $book_data) { ?>
		<div class="col-6">
			<div class="row d-flex justify-content-between align-items-center" style="border-bottom: 1px solid 
			#9c9c9c;">
				<div class="col-4"><img src="img/<?php echo $book_data['book_photo'];   ?>" width="150"></div>
				<div class="col-4"><h4><a href="book.php?id=<?php echo $book_data['book_id'];?>"><?php echo $book_data['book_name']; ?></a></h4><br><h5><?php echo $book_data['book_author']; ?></h5></div>
				<div class="col-4"><button class="btn btn-outline-success"><a href="MyCart.php">My cart</a></button>	</div>
			</div>
		</div>
		<?php  } ?>
		</div>
		...
		<div class="container">
		  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
		    ...
		    <ul class="nav col-md-4 justify-content-end">
		      ...
		      <li class="nav-item"><a href="#"><img src="img/cart.png" class="hvr-grow"></a></li>
