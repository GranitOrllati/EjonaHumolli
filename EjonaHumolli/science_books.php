...
$selectScienceBooks = $con->prepare($sql);
$selectScienceBooks->execute();
$scienceBooks_data = $selectScienceBooks->fetchAll();
?>
 ?>
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Science Books</h1>

    <div class="row">
<?php foreach ($scienceBooks_data as $book_data) { ?>
