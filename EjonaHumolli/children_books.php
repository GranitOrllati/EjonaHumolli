...
$selectChildrenBooks = $con->prepare($sql);
$selectChildrenBooks->execute();
$childrenBooks_data = $selectChildrenBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Children Books</h1>

    <div class="row">
<?php foreach ($childrenBooks_data as $book_data) { ?>
