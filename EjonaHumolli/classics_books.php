...
$selectClassicBooks = $con->prepare($sql);
$selectClassicBooks->execute();
$classicBooks_data = $selectClassicBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Classic Books</h1>

    <div class="row">
<?php foreach ($classicBooks_data as $book_data) { ?>
