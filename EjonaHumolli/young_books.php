...
$sql = "SELECT b.*, g.name AS genre_name
        ...
        WHERE g.name = 'Young Adult'
        ORDER BY b.book_id DESC";

$selectYABooks = $con->prepare($sql);
$selectYABooks->execute();
$yABooks_data = $selectYABooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Young Adult Books</h1>

    <div class="row">
<?php foreach ($yABooks_data as $book_data) { ?>
