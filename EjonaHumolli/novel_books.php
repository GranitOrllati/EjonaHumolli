...
$selectNovelBooks = $con->prepare($sql);
$selectNovelBooks->execute();
$novelBooks_data = $selectNovelBooks->fetchAll();
...
<head>
  ...
  <body>
    ...
    <h1 class="header-h1" >Novels</h1>

    <div class="row">
<?php foreach ($novelBooks_data as $book_data) { ?>
